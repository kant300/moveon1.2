...
import markerIcon_red from "../../assets/images/icons/marker_red.png"
        ...
        <Header />
            <div id="container">
                <div id="map" style={{width: '420px', height: '79vh'}}>
                    ...
                    }}>지하철 엘리베이터/에스컬레이터 위치 정보</div>
                    <button id="mapLocation" type="button" onClick={() => moveToInitialPosition()}><img src={my_location} style={{
                        position: 'absolute',
                        top: '50px',
                        left: '10px',
                        zIndex: 10,
