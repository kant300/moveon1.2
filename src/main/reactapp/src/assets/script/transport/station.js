        ...
        window.kakao.maps.load(() => {
            ...
            const createMap = async () => {
                ...
                const getStationData = async () => {
                    ...
                    // A-1. 매핑된 데이터를 가져옵니다
                    const st_response = await axios.get("http://localhost:8080/station/location");
                    ...
                    for (let i=0; i<st_data.length; i++) {
                        ...
                        // B-1. 매핑된 데이터를 가져옵니다
                        const sc_response = await axios.get("http://localhost:8080/station/schedule?station_name="+obj.역사명);
